...
#         self.pos_embed_Lin = nn.Linear(1, cfg["dim"]) # nn.Embedding(cfg["max_len"], cfg["dim"]) # position embedding
        if cfg["operation_with_pos_encoding"] == "concatenate":
            ...
            if self.Spectral_normalization:
                ...
                # self.pos_embed_3DLin = nn.utils.parametrizations.spectral_norm(nn.Linear(3, int(cfg["dim"]/2))) # position embedding: x,y,t or 512 after gaussian-fourier mapping
            else:
            ...
            # self.pos_embed_3DLin_GaussMap = nn.Linear(512, cfg["dim"]) # position embedding: x,y,t or 512 after gaussian-fourier mapping
...
class MultiHeadedSelfAttention(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.fast_attention = False #cfg["fast_attention"]
